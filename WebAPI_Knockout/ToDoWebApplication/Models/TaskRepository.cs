...
namespace ToDoClassLibrary
{
	...
	{
		private readonly IUserTaskList _userTaskList;

		public TaskRepository(IUserTaskList userTaskList)
		{
			this._userTaskList = userTaskList;
		}

		public async Task<bool> Create(UserTask task)
		{
			var taskList = await _userTaskList.GetTaskList();
		...
		{
			return await _userTaskList.GetTaskList(); 
		}
